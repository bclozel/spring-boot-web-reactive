...
@ConditionalOnClass({DispatcherHandler.class, HttpHandler.class, WebReactiveConfigurer.class})
@AutoConfigureAfter({ReactiveHttpServerAutoConfiguration.class})
public class ReactiveWebAutoConfiguration {
    @Configuration
    @Import(EnableWebReactiveConfig.class)
    public static class WebReactiveConfigurationAdapter implements WebReactiveConfigurer {

    }

    @Configuration
    @EnableConfigurationProperties({ResourceProperties.class, WebReactiveProperties.class})
    public static class EnableWebReactiveConfig extends DelegatingWebReactiveConfiguration {

        private static final Log logger = LogFactory
                .getLog(EnableWebReactiveConfig.class);
        ...
        public EnableWebReactiveConfig(ResourceProperties resourceProperties,
